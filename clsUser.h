...
private:       
    ...
    static string _ConverUserObjectToLine(clsUser User, string Seperator = "#//#")
    {
        ...
        UserRecord += clsUtil::Encryption(User.GetPassword()) + Seperator;
    ...
    string _PrepareLogInRecord( string Seperator = "#//#")
    {
        ...
        LoginRecord += clsUtil::Encryption(GetPassword()) + Seperator;
...
public:
    ...
    enum enMainMenuePermissions
      {
        eAll = -1 , pShowClient = 1 , pAddNewClient = 2 , pDeleteClient = 4 , pUpdateClient = 8 , pFindClient = 16 , pTransaction = 32 , pManageusers = 64 , pShowRegisterUsers = 128
      };
    ...
    bool CheckAccessPermission (clsUser::enMainMenuePermissions Permissions)
    {

      if(this ->_Permissions == clsUser::enMainMenuePermissions::eAll)
        return true;
